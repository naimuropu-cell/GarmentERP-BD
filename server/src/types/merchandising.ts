...
export interface Buyer {
  ...
  paymentTerms: string; // e.g. 'LC at sight', 'TT 60 days'
...
export interface MeasurementSpec {
  ...
  specsBySize: Record<string, number>; // Size -> cm (e.g. S: 48, M: 50, L: 52)
}
...
export interface GarmentStyle {
  ...
  productCategory: string; // 'Knitwear', 'Woven', 'Outerwear'
  garmentType: string; // 'Polo Shirt', 'Crewneck T-Shirt', 'Fleece Hoodie'
  brand: string;
