        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-brand-500/20 text-brand-400 border border-brand-500/30 flex items-center gap-1.5">
                ...
                Phase 1 Active • Foundation & RBAC
              </span>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-xs font-bold shadow-lg shadow-brand-600/30 flex items-center gap-2 transition-all hover:scale-105 active:scale-95"
            >
              <Building2 className="w-4 h-4" />
              <span>Explore Factory Tree</span>
        ...
        <div className="lg:col-span-8 glass-panel p-6 rounded-2xl border border-slate-800 space-y-5">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                mod: 'Module 06 & 07: BOM, MRP & Multi-Warehouse SCM',
                desc: 'Automatic consumption calculation, shortage requisitions, supplier rating, GRN, and strict negative inventory prohibition.',
                status: 'QUEUED',
                tag: 'Phase 3',
                active: false
              },
          ...
          <div className="glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
            ...
            <div className="space-y-2">
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs">
                <p className="font-semibold text-slate-200">Postman Automated Collection</p>
                <p className="text-[10px] text-slate-400 font-mono mt-0.5">postman/GarmentERP_Auth_RBAC.postman_collection.json</p>
              </div>
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs">
